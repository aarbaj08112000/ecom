  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    ...
    <nav aria-label="breadcrumb">
      ...
      <div class="dt-top-btn d-grid gap-2 d-md-flex justify-content-md-end mb-5">
        ...
        <button type="button" class="btn btn-seconday" data-bs-toggle="modal" data-bs-target="#addAttributes" title="Add Attribute">
      ...
      <div class="modal fade" id="addAttributes" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
         <div class="modal-dialog  modal-dialog-centered" role="document">
            <div class="modal-content">
               ...
               <form action="<%base_url('add_attributes')%>" method="POST" enctype="multipart/form-data" id="add_attributes" class="add_attributes custom-form">
               <div class="modal-body">
                  <div class="form-group">
                  </div>
                  <div class="form-group">
                  	<label for="on click url">Attributes<span class="text-danger">*</span></label> <br>
                  	<input  type="text" name="attribute_name" placeholder="Enter Attributes Name" class="form-control required-input" value="" >
                  </div>
            ...
            <table width="100%" border="1" cellspacing="0" cellpadding="0" class="table table-striped" style="border-collapse: collapse;" border-color="#e1e1e1" id="attributes">
              ...
              <%if ($attribute) %>
                     ...
                     <tr>
                       ...
                       <span class="delete_data" title="Delete Record" data-id="<%$val['attribute_id']%>"><i class="ti ti-trash"></i>
                       </span>
						         ...
						         <div class="modal-dialog  modal-dialog-centered" role="document">
						            <div class="modal-content">
						               ...
						               <div class="modal-body">
						                  ...
						                  <div class="form-group">
						                  	<label for="on click url">Attribute Name<span class="text-danger">*</span></label> <br>
						                  	<input  type="text" name="attribute_name" placeholder="Enter Attribute Name" class="form-control required-input" value="<%$val['attribute_name'] %>" >
						                  </div>
    ...
    <script src="<%$base_url%>public/js/admin_panel/attributes.js">"></script>
